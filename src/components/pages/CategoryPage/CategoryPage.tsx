...
const CategoryPage = observer(() => {
    ...
    return LoadersState.isFilterPageLoaded ? (
        <FilterPageLoader />
    ) : (
        <div className="category">
            <h1 className="category__title section-title">
                Товаров найдено ({CategoryPageState.categoryPageItems.length})
            </h1>
            <div className="category__inner">
                ...
                <div>
                    ...
                    <ul className="category__list category-list">
                        {CategoryPageState.categoryPageItems.length > 0
                            ? CategoryPageState.categoryPageItems.map((item: ICategoryPageItem) => {
                                const { images, title, releaseDate, priceInfo, isAvailable, rating, features } =
                                    item;
